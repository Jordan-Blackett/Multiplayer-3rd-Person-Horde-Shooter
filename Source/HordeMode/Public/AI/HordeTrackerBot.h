...
#include "HordeTrackerBot.generated.h"
...
UCLASS()
class HORDEMODE_API AHordeTrackerBot : public APawn
{
	GENERATED_BODY()
...
protected:
	...
	UFUNCTION()
	void HandleTakeDamage(UHordeHealthComponent* OwningHealthComp, float Health, float HealthDelta, const class UDamageType* DamageType,
